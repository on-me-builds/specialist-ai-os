# LinkedIn draft — Teardown #001 — Product Factory v0.4: one YAML in, four deliverables out

I spent some time on a teardown: Teardown #001 — Product Factory v0.4: one YAML in, four deliverables out.
