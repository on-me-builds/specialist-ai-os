# Hacker News draft — Teardown #001 — Product Factory v0.4: one YAML in, four deliverables out

Suggested title: Teardown #001 — Product Factory v0.4: one YAML in, four deliverables out
